...
class AddRecepeDevEntryThree(models.Model):
    ...
    user = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='user_id', db_constraint=False)
...
class AddRecepeDevEntryTwo(models.Model):
    ...
    user = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='user_id', db_constraint=False)
    recepe_name = models.CharField(max_length=50)
    food_category = models.ForeignKey('TblFoodCategory', on_delete=models.SET_NULL,null=True,blank=True, db_column='food_category_id', db_constraint=False)
    food_style = models.ForeignKey('TblFoodstyleMaster', on_delete=models.SET_NULL,null=True,blank=True, db_column='food_style_id', db_constraint=False)
    country = models.ForeignKey('TblCountry', on_delete=models.SET_NULL,null=True,blank=True, db_column='country_id', db_constraint=False)
    state = models.ForeignKey('TblState', on_delete=models.SET_NULL,null=True,blank=True, db_column='state_id', db_constraint=False)
    uom_master_id = models.CharField(max_length=50)
...
class Blog(models.Model):
    ...
    user = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='user_id', db_constraint=False)
    status = models.ForeignKey('TblStatus', on_delete=models.SET_NULL,null=True,blank=True, db_column='status_id', db_constraint=False)
...
class CallBack(models.Model):
    ...
    diet = models.ForeignKey('TblDietician', on_delete=models.SET_NULL,null=True,blank=True, db_column='diet_id', db_constraint=False)
    patient = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='patient_id', db_constraint=False)
...
class Cart(models.Model):
    user = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='user_id', db_constraint=False)
    product = models.ForeignKey('Products', on_delete=models.SET_NULL,null=True,blank=True, db_column='product_id', db_constraint=False)
...
class Category(models.Model):
    ...
    posted_by = models.ForeignKey('Users', on_delete=models.SET_NULL, blank=True, null=True, db_column='posted_by', db_constraint=False)
    created_at = models.DateTimeField()
...
class Details(models.Model):
    sales = models.ForeignKey('Sales', on_delete=models.SET_NULL,null=True,blank=True, db_column='sales_id', db_constraint=False)
    product = models.ForeignKey('Products', on_delete=models.SET_NULL,null=True,blank=True, db_column='product_id', db_constraint=False)
    quantity = models.IntegerField()
...
class DietFoodStyleAdd(models.Model):
    ...
    food_style_master = models.ForeignKey('DietFoodStyleMaster', on_delete=models.SET_NULL,null=True,blank=True, db_column='food_style_master_id', db_constraint=False)
...
class DietFoodStyleDataAdd(models.Model):
    country = models.ForeignKey('TblCountry', on_delete=models.SET_NULL,null=True,blank=True, db_column='country_id', db_constraint=False)
    state = models.ForeignKey('TblState', on_delete=models.SET_NULL,null=True,blank=True, db_column='state_id', db_constraint=False)
    city = models.ForeignKey('TblCity', on_delete=models.SET_NULL,null=True,blank=True, db_column='city_id', db_constraint=False)
    community = models.ForeignKey('TblCommunity', on_delete=models.SET_NULL,null=True,blank=True, db_column='community_id', db_constraint=False)
    food_style_add = models.ForeignKey('DietFoodStyleAdd', on_delete=models.SET_NULL,null=True,blank=True, db_column='food_style_add_id', db_constraint=False)
    patient = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='patient_id', related_name='diet_food_style_data_add_patients', db_constraint=False)
    created_at = models.DateField()
    created_by = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='created_by', related_name='diet_food_style_data_add_created', db_constraint=False)
...
class DietFoodStyleMaster(models.Model):
    ...
    created_at = models.DateField()
    posted_by = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='posted_by', db_constraint=False)
...
class DietFoodTaken(models.Model):
    ...
    posted_by = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='posted_by', related_name='diet_food_taken_posted', db_constraint=False)
    patient = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='patient_id', related_name='diet_food_taken_patients', db_constraint=False)
...
class DietPlanMaster(models.Model):
    ...
    dietplan = models.ForeignKey('TblDietplanAddMasterTable', on_delete=models.SET_NULL,null=True,blank=True, db_column='dietplan_id', db_constraint=False)
    status = models.IntegerField()
    created_at = models.DateField()
    created_by = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='created_by', db_constraint=False)
...
class DietSvasthFoodGroupAdd(models.Model):
    ...
    food_group = models.ForeignKey('DietSvasthfoodGroupMaster', on_delete=models.SET_NULL,null=True,blank=True, db_column='food_group_id', db_constraint=False)
    created_at = models.DateField()
    created_by = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='created_by', db_constraint=False)
...
class DietSvasthGroupAddData(models.Model):
    food_group_add = models.ForeignKey('DietSvasthFoodGroupAdd', on_delete=models.SET_NULL,null=True,blank=True, db_column='food_group_add_id', db_constraint=False)
    food_style_add = models.ForeignKey('DietFoodStyleAdd', on_delete=models.SET_NULL,null=True,blank=True, db_column='food_style_add_id', db_constraint=False)
    dietitian_comment = models.CharField(max_length=250)
    patient = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='patient_id', related_name='diet_svasth_group_add_data_patients', db_constraint=False)
    created_at = models.DateField()
    created_by = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='created_by', related_name='diet_svasth_group_add_data_created', db_constraint=False)
...
class IpaddressLikesMap(models.Model):
    tutorial = models.ForeignKey('Tutorial', on_delete=models.SET_NULL,null=True,blank=True, db_column='tutorial_id', db_constraint=False)
...
class Likes(models.Model):
    user = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='userid', related_name='likes_user', db_constraint=False)
    posted_by = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='posted_by', related_name='likes_posted_by', db_constraint=False)
...
class MyPages(models.Model):
    ...
    food_master = models.ForeignKey('TblFoodMaster', on_delete=models.SET_NULL,null=True,blank=True, db_column='food_master_id', db_constraint=False)
    sub_group = models.ForeignKey('TblFoodSubgroup', on_delete=models.SET_NULL,null=True,blank=True, db_column='sub_group_id', db_constraint=False)
    food_main = models.ForeignKey('TblFoodMainCode', on_delete=models.SET_NULL,null=True,blank=True, db_column='food_main_id', db_constraint=False)
...
class Products(models.Model):
    category = models.ForeignKey('Category', on_delete=models.SET_NULL,null=True,blank=True, db_column='category_id', db_constraint=False)
...
class StandardReportChat(models.Model):
    ...
    diet = models.ForeignKey('TblDietician', on_delete=models.SET_NULL, blank=True, null=True, db_column='diet_id', db_constraint=False)
    created_at = models.DateTimeField()
    updated_at = models.DateTimeField()
...
class TblCallCenterAdd(models.Model):
    cal_ceneter = models.ForeignKey('TblCallCenter', on_delete=models.SET_NULL,null=True,blank=True, db_column='cal_ceneter_id', db_constraint=False)
...
class TblDevelopSchedule(models.Model):
    ...
    food_packing = models.ForeignKey('TblFoodPacking', on_delete=models.SET_NULL,null=True,blank=True, db_column='food_packing_id', db_constraint=False)
    patient = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='patient_id', related_name='tbldevelopschedule_patients', db_constraint=False)
    created_at = models.DateField()
    posted_by = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='posted_by', related_name='tbldevelopschedule_posted', db_constraint=False)
...
class TblDietAddSnacks(models.Model):
    ...
    snacks = models.ForeignKey('TblDietSnacks', on_delete=models.SET_NULL,null=True,blank=True, db_column='snacks_id', db_constraint=False)
    time_slot = models.CharField(max_length=50)
    snacks_name = models.CharField(max_length=50)
    patient = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='patient_id', related_name='tbldietaddsnacks_patients', db_constraint=False)
    posted_by = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='posted_by', related_name='tbldietaddsnacks_posted', db_constraint=False)
    created_at = models.CharField(max_length=50)
...
class TblDietChatMenu(models.Model):
    ...
    patient = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='patient_id', related_name='tbldietchatmenu_patients', db_constraint=False)
    posted_by = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='posted_by', related_name='tbldietchatmenu_posted', db_constraint=False)
    created_at = models.DateTimeField(blank=True, null=True)
    updated_at = models.DateTimeField(blank=True, null=True)
...
class TblDietPlansAdd(models.Model):
    ...
    diet_pln = models.ForeignKey('DietPlanMaster', on_delete=models.SET_NULL,null=True,blank=True, db_column='diet_pln_id', db_constraint=False)
    created_at = models.DateField()
    created_by = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='created_by', db_constraint=False)
...
class TblDietician(models.Model):
    ...
    role = models.ForeignKey('TblRole', on_delete=models.SET_NULL,null=True,blank=True, db_column='role_id', db_constraint=False)
    created_at = models.DateTimeField()
...
class TblDieticianComment(models.Model):
    ...
    created_at = models.DateField()
    created_by = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='created_by', related_name='tbldieticiancomment_created', db_constraint=False)
    patient = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='patient_id', related_name='tbldieticiancomment_patients', db_constraint=False)
...
class TblDieticianFoodAvoid(models.Model):
    ...
    patient = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='patient_id', related_name='tbldieticianfoodavoid_patients', db_constraint=False)
    created_by = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='created_by', related_name='tbldieticianfoodavoid_created', db_constraint=False)
    created_at = models.DateTimeField(blank=True, null=True)
...
class TblDietplanMasterTable(models.Model):
    ...
    dietplan = models.ForeignKey('TblDietplanAddMasterTable', on_delete=models.SET_NULL,null=True,blank=True, db_column='dietplan_id', db_constraint=False)
    dietitian_comment = models.CharField(max_length=250)
    created_by = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='created_by', related_name='tbldietplanmastertable_created', db_constraint=False)
    created_at = models.DateField()
    patient = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='patient_id', related_name='tbldietplanmastertable_patients', db_constraint=False)
...
class TblDoctorsComment(models.Model):
    ...
    created_at = models.DateField()
    doctor = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='doctor_id', related_name='tbldoctorscomment_doctors', db_constraint=False)
    patient = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='patient_id', related_name='tbldoctorscomment_patients', db_constraint=False)
...
class TblFoodDietIndexData(models.Model):
    m_id = models.ForeignKey('MyPages', on_delete=models.SET_NULL,null=True,blank=True, db_column='m_id', db_constraint=False)
    calorie = models.CharField(max_length=250)
    carbo_hydrates = models.CharField(max_length=250)
    vitamins = models.CharField(max_length=250)
    fats = models.CharField(max_length=250)
...
class TblFoodPlanGenerator(models.Model):
    week = models.ForeignKey('TblWeeks', on_delete=models.SET_NULL,null=True,blank=True, db_column='week_id', db_constraint=False)
    d_id = models.ForeignKey('TblDays', on_delete=models.SET_NULL,null=True,blank=True, db_column='d_id', db_constraint=False)
    food_master = models.ForeignKey('TblFoodMaster', on_delete=models.SET_NULL,null=True,blank=True, db_column='food_master_id', db_constraint=False)
    food_style_add = models.ForeignKey('DietFoodStyleAdd', on_delete=models.SET_NULL,null=True,blank=True, db_column='food_style_add_id', db_constraint=False)
    country = models.ForeignKey('TblCountry', on_delete=models.SET_NULL,null=True,blank=True, db_column='country_id', db_constraint=False)
    state = models.ForeignKey('TblState', on_delete=models.SET_NULL,null=True,blank=True, db_column='state_id', db_constraint=False)
    items = models.ForeignKey('TblItems', on_delete=models.SET_NULL,null=True,blank=True, db_column='items_id', db_constraint=False)
    ...
    posted_by = models.ForeignKey('Users', on_delete=models.SET_NULL, null=True, blank=True, db_column='posted_by', related_name='tblfoodplangenerator_posted', db_constraint=False)
    patient = models.ForeignKey('Users', on_delete=models.SET_NULL, null=True, blank=True, db_column='patient_id', related_name='tblfoodplangenerator_patients', db_constraint=False)
...
class TblFoodProduct(models.Model):
    ...
    category = models.ForeignKey('TblFoodCategory', on_delete=models.SET_NULL,null=True,blank=True, db_column='category_id', db_constraint=False)
...
class TblFoodProductMaster(models.Model):
    ...
    uom_master = models.ForeignKey('TblUomMaster', on_delete=models.SET_NULL,null=True,blank=True, db_column='uom_master_id', db_constraint=False)
    ingredients = models.ForeignKey('TblIngredientsMaster', on_delete=models.SET_NULL,null=True,blank=True, db_column='ingredients_id', db_constraint=False)
    uom = models.IntegerField()
    ing_base_qty = models.IntegerField()
    suppliers = models.ForeignKey('TblSuppliers', on_delete=models.SET_NULL,null=True,blank=True, db_column='suppliers_id', db_constraint=False)
    created_at = models.DateField()
    posted_by = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='posted_by', db_constraint=False)
...
class TblInputBom(models.Model):
    ...
    cltrl = models.CharField(max_length=50)
    irn = models.CharField(max_length=50)
    cmp_id = models.ForeignKey('TblCompositionIndex', on_delete=models.SET_NULL,null=True,blank=True, db_column='cmp_id', db_constraint=False)
    created_at = models.CharField(max_length=50)
...
class TblNutritionValProducts(models.Model):
    ...
    nutrition_food = models.ForeignKey('TblNutritionFood', on_delete=models.SET_NULL,null=True,blank=True, db_column='nutrition_food_id', db_constraint=False)
    servining_size = models.ForeignKey('TblNutritionServiningSize', on_delete=models.SET_NULL,null=True,blank=True, db_column='servining_size_id', db_constraint=False)
...
class TblOrderSentLogistic(models.Model):
    ...
    u_id = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='u_id', related_name='tblordersentlogistic_users', db_constraint=False)
    created_by = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='created_by', related_name='tblordersentlogistic_created', db_constraint=False)
    created_at = models.CharField(max_length=50)
...
class TblPatientHealth(models.Model):
    ...
    healthparameter_master = models.ForeignKey('TblHealthparameterMaster', on_delete=models.SET_NULL,null=True,blank=True, db_column='healthparameter_master_id', db_constraint=False)
    product = models.ForeignKey('TblFoodProduct', on_delete=models.SET_NULL,null=True,blank=True, db_column='product_id', db_constraint=False)
    ...
    patient = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='patient_id', related_name='tblpatienthealth_patients', db_constraint=False)
    created_at = models.DateTimeField()
    status = models.ForeignKey('TblStatus', on_delete=models.SET_NULL,null=True,blank=True, db_column='status_id', db_constraint=False)
    posted_by = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='posted_by', related_name='tblpatienthealth_posted', db_constraint=False)
...
class TblQuestionSuggestionPat(models.Model):
    patient = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='patient_id', related_name='tblquestionsuggestionpat_patients', db_constraint=False)
    suggest = models.CharField(max_length=1000)
    created_at = models.CharField(max_length=50)
    posted_by = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='posted_by', related_name='tblquestionsuggestionpat_posted', db_constraint=False)
...
class TblRcpBuilder(models.Model):
    ...
    ingredients_master = models.ForeignKey('TblIngredientsMaster', on_delete=models.SET_NULL,null=True,blank=True, db_column='ingredients_master_id', db_constraint=False)
    input_code = models.CharField(max_length=50)
    food_name_data = models.CharField(max_length=50)
    clrs = models.CharField(max_length=50)
    crbhydrts = models.CharField(max_length=50)
    ...
    cltrl = models.CharField(max_length=50)
    irn = models.CharField(max_length=50)
    v_id = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='v_id', related_name='tblrcpbuilder_users', db_constraint=False)
    add_recepe = models.CharField(max_length=1000)
    diet_plan_for = models.CharField(max_length=50)
    created_at = models.CharField(max_length=50)
    created_by = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='created_by', related_name='tblrcpbuilder_created', db_constraint=False)
...
class TblScmPersonAdd(models.Model):
    scm_person = models.ForeignKey('TblScmPerson', on_delete=models.SET_NULL, null=True, blank=True, db_column='scm_person_id', db_constraint=False)
    message = models.CharField(max_length=50)
    created_at = models.IntegerField()
    created_by = models.ForeignKey('Users', on_delete=models.SET_NULL, null=True, blank=True, db_column='created_by', db_constraint=False)
...
class TblSvasthFoodMasterDataAdd(models.Model):
    food_master = models.ForeignKey('TblFoodMaster', on_delete=models.SET_NULL,null=True,blank=True, db_column='food_master_id', db_constraint=False)
    food_masters = models.ForeignKey('TblFoodMaster', on_delete=models.SET_NULL,null=True,blank=True, db_column='food_masters_id', related_name='svasth_food_masters', db_constraint=False)
    sub_group = models.ForeignKey('TblFoodSubgroup', on_delete=models.SET_NULL,null=True,blank=True, db_column='sub_group_id', db_constraint=False)
    ...
    patient = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='patient_id', related_name='tblsvasthfoodmasterdataadd_patients', db_constraint=False)
    created_at = models.DateField()
    created_by = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='created_by', related_name='tblsvasthfoodmasterdataadd_created', db_constraint=False)
...
class TblSvasthHealthyTips(models.Model):
    ...
    patient = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='patient_id', related_name='tblsvasthhealthytips_patients', db_constraint=False)
    posted_by = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='posted_by', related_name='tblsvasthhealthytips_posted', db_constraint=False)
    created_at = models.CharField(max_length=50)
...
class TblSvasthNutrient(models.Model):
    code = models.CharField(max_length=50)
    snp_parameter = models.ForeignKey('TblSvasthSnpParameters', on_delete=models.SET_NULL, null=True, blank=True, db_column='snp_parameter_id', db_constraint=False)
...
class TblSvasthhealthPm(models.Model):
    ...
    patient = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='patient_id', related_name='tblsvasthhealthpm_patients', db_constraint=False)
    posted_by = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='posted_by', related_name='tblsvasthhealthpm_posted', db_constraint=False)
    created_at = models.DateField()
...
class TblUploadHealthChart(models.Model):
    ...
    posted_by = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='posted_by', db_constraint=False)
    updated_by_dietitian = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='updated_by_dietitian', related_name='health_chart_updates', db_constraint=False)
...
class TblUploadReport(models.Model):
    ...
    posted_by = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='posted_by', db_constraint=False)
    diet = models.ForeignKey('TblDietician', on_delete=models.SET_NULL,null=True,blank=True, db_column='diet_id', db_constraint=False)
    updated_by_dietitian = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='updated_by_dietitian', related_name='report_updates', db_constraint=False)
...
class TblUploadReports(models.Model):
    ...
    date = models.DateField()
    posted_by = models.ForeignKey('Users', on_delete=models.SET_NULL, null=True, blank=True, db_column='posted_by', db_constraint=False)
    updated_by_dietitian = models.ForeignKey('Users', on_delete=models.SET_NULL, null=True, blank=True, db_column='updated_by_dietitian', related_name='upload_reports_updates', db_constraint=False)
...
class Users(models.Model):
    ...
    company_status = models.ForeignKey('TblCompanyStatus', on_delete=models.SET_NULL, blank=True, null=True, db_column='company_status_id', db_constraint=False)
...
class ViewRating(models.Model):
    ...
    post = models.ForeignKey('Tutorial', on_delete=models.SET_NULL, null=True, blank=True, db_column='post_id', db_constraint=False)
    rating_number = models.IntegerField()
    total_points = models.IntegerField()
    patient = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='patient_id', related_name='viewrating_patients', db_constraint=False)
    posted_by = models.ForeignKey('Users', on_delete=models.SET_NULL,null=True,blank=True, db_column='posted_by', related_name='viewrating_posted', db_constraint=False)
