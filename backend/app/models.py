...
class UserQuestionnaire(models.Model):
    ...
    dietitian_consultation_before = models.BooleanField(null=True, blank=True)
    dietitian_consultation_name = models.CharField(max_length=200, null=True, blank=True)
    dietitian_consultation_specialty = models.CharField(max_length=200, null=True, blank=True)
    dietitian_consultation_phone = models.CharField(max_length=30, null=True, blank=True)
    dietitian_consultation_location = models.CharField(max_length=200, null=True, blank=True)
    dietitian_consultation_notes = models.TextField(null=True, blank=True)
