...
router.register(r'admin-plan-billing-overview', AdminPlanBillingOverviewViewSet, basename='admin-plan-billing-overview')
router.register(r'admin-microkitchen-patients', AdminMicroKitchenPatientsViewSet, basename='admin-microkitchen-patients')
router.register(r'admin-microkitchen-patient-cards', AdminMicroKitchenPatientCardsViewSet, basename='admin-microkitchen-patient-cards')
...
urlpatterns = [
    ...
    path(
        "admin-nutritionist-reviews-paginated/",
        views.AdminNutritionistReviewsPaginatedView.as_view(),
        name="admin-nutritionist-reviews-paginated",
    ),
    path(
        "admin-nutritionist-tickets-paginated/",
        views.AdminNutritionistTicketsPaginatedView.as_view(),
        name="admin-nutritionist-tickets-paginated",
    ),
    path(
    ...
    path('user-roles-by-identifier/', UserRolesByIdentifierView.as_view(), name='user_roles_by_identifier'),
    path('user-details-by-identifier/', UserDetailsByIdentifierView.as_view(), name='user_details_by_identifier'),
