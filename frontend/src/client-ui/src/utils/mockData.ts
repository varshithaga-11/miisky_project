...
export const MOCK_DEPARTMENTS: Department[] = [
  { id: 1, name: "Cardiology",        icon: "icon-18", image: "/assets/images/service/service-1.jpg", description: "Cardiologists are healthcare professionals specializing in heart conditions." },
  { id: 2, name: "Dental",            icon: "icon-19", image: "/assets/images/service/service-2.jpg", description: "Dentists are healthcare professionals specializing in oral health." },
  { id: 3, name: "Gastroenterology",  icon: "icon-20", image: "/assets/images/service/service-3.jpg", description: "Gastroenterologists specialize in digestive system disorders." },
  { id: 4, name: "Ophthalmology",     icon: "icon-18", image: "/assets/images/service/service-1.jpg", description: "Eye care specialists focusing on vision and ocular health." },
  { id: 5, name: "Neurology",         icon: "icon-19", image: "/assets/images/service/service-2.jpg", description: "Neurologists treat disorders of the nervous system." },
  { id: 6, name: "Orthopedics",       icon: "icon-20", image: "/assets/images/service/service-3.jpg", description: "Orthopedic surgeons specialize in musculoskeletal conditions." },
];
...
export const MOCK_SERVICES: Service[] = [
  { id: 1, title: "Heart Health",       icon: "icon-18", image: "/assets/images/service/service-1.jpg", description: "Comprehensive heart health monitoring and treatment." },
  { id: 2, title: "Dental Care",        icon: "icon-19", image: "/assets/images/service/service-2.jpg", description: "Complete dental care from routine cleaning to orthodontics." },
  { id: 3, title: "Digestive Health",   icon: "icon-20", image: "/assets/images/service/service-3.jpg", description: "Diagnostic and therapeutic gastroenterology services." },
];
...
export const MOCK_PORTFOLIO: PortfolioItem[] = [
  { id: 1, title: "Eye Surgery",         category: "Ophthalmology",     image: "/assets/images/gallery/gallery-1.jpg" },
  { id: 2, title: "Cardiology Unit",     category: "Cardiology",        image: "/assets/images/gallery/gallery-2.jpg" },
  { id: 3, title: "Dental Clinic",       category: "Dental",            image: "/assets/images/gallery/gallery-3.jpg" },
  { id: 4, title: "Lab Research",        category: "Research",          image: "/assets/images/gallery/gallery-4.jpg" },
  { id: 5, title: "Patient Recovery",    category: "General",           image: "/assets/images/gallery/gallery-5.jpg" },
  { id: 6, title: "Emergency Wing",      category: "Emergency",         image: "/assets/images/gallery/gallery-6.jpg" },
];
...
export const MOCK_TESTIMONIALS: Testimonial[] = [
  ...
  },
  {
    ...
    name: "Emily Thompson",
    role: "Patient",
    avatar: "/assets/images/resource/testimonial-3.jpg",
    rating: 4,
