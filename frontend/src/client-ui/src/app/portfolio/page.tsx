                    ...
                    <div className="col-lg-4 col-md-6 col-sm-12 portfolio-block">
                        <div className="portfolio-block-one">
                            <div className="inner-box">
                                ...
                                <div className="view-btn"><Link to="assets/images/gallery/portfolio-7.jpg" className="lightbox-image" data-fancybox="gallery"><i className="icon-24"></i></Link></div>
                                <div className="text-box">
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-12 portfolio-block">
                        <div className="portfolio-block-one">
                            <div className="inner-box">
                                ...
                                <div className="view-btn"><Link to="assets/images/gallery/portfolio-8.jpg" className="lightbox-image" data-fancybox="gallery"><i className="icon-24"></i></Link></div>
                                <div className="text-box">
