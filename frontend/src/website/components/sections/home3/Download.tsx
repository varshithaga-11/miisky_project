  ...
  return (
        <section className="download-section pt_120">
            <div className="pattern-layer">
                <div className="pattern-1" style={{ backgroundImage: "url(/website/assets/images/shape/shape-39.png)" }}></div>
                <div className="pattern-2" style={{ backgroundImage: "url(/website/assets/images/shape/shape-40.png)" }}></div>
            </div>
            <figure className="ambulance"><Image src="/website/assets/images/resource/ambulance-2.png" alt="Image" width={453} height={254} priority /></figure>
            <figure className="image-layer"><Image src="/website/assets/images/resource/download-1.jpg" alt="Image" width={728} height={782} priority /></figure>
                    ...
                    <div className="col-lg-6 col-md-12 col-sm-12 form-column">
                        <div className="content_block_seven">
                            <div className="content-box ml_100">
                                <div className="shape" style={{ backgroundImage: "url(/website/assets/images/shape/shape-33.png)" }}></div>
                                <h3>Make an Appointment</h3>
                                <form method="post" action="/website/index-3" className="default-form">
                                    ...
                                    <div className="form-group">
                                        <div className="icon"><Image src="/website/assets/images/icons/icon-15.svg" alt="Icon" width={15} height={15} priority /></div>
