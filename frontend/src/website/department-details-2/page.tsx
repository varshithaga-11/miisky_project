                            ...
                            <div className="col-lg-8 col-md-12 col-sm-12 content-side">
                                <div className="service-details-content">
                                    <div className="content-one mb_40">
                                        <figure className="image-box mb_60"><Image src={department.image || "/website/assets/images/service/service-6.jpg"} alt={department.name} width={856} height={525} priority /></figure>
