...
const UserManagementPage: React.FC = () => {
  ...
  // Locked to supply_chain for this page
  const roleFilter = "supply_chain";
  ...
  return (
    <>
      <PageMeta title="Supply Chain User Management" description="Manage supply chain users" />
      <PageBreadcrumb pageTitle="Supply Chain User Management" />
      ...
      <div className="mb-6 space-y-4">
        <div className="flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center">
          <div className="relative flex-1 max-w-md">
            <input
              type="text"
              placeholder="Search supply chain users..."
              value={searchTerm}
      ...
      <ConfirmationModal
        ...
        message="Are you sure you want to deactivate this supply chain user?"
      ...
      {viewUser && (
        <div className="fixed inset-0 bg-white/50 backdrop-blur-sm flex items-center justify-center z-[9999]">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg w-full max-w-2xl relative shadow-xl max-h-[90vh] overflow-y-auto">
            ...
            <h2 className="text-xl font-bold mb-6 text-gray-900 dark:text-white">User Info</h2>
