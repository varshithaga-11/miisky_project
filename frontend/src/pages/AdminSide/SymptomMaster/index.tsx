...
const SymptomMasterPage: React.FC = () => {
  ...
  const [sortField, setSortField] = useState<keyof SymptomMaster | null>("sort_order");
  ...
  const fetchRows = async () => {
    setLoading(true);
    try {
      const r = await getSymptomMasterList(currentPage, pageSize, searchTerm);
      setRows(r.results);
  ...
  const handleSort = (field: keyof SymptomMaster) => {
...
export default SymptomMasterPage;
