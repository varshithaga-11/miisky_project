...
import { createState, State } from "./stateapi";
...
interface AddStateProps {
  onClose: () => void;
  onAdd: (newState: State) => void;
}

const AddState: React.FC<AddStateProps> = ({ onClose, onAdd }) => {
  ...
  return (
    <div className="fixed inset-0 bg-white/50 backdrop-blur-sm flex items-center justify-center z-50">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 w-full max-w-md relative mt-24">
        ...
        <h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">Add New State</h2>
