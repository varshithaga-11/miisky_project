              ...
              <section className="space-y-4">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div>
                    ...
                    <Input id="vitamin_b1" type="number" step="0.1" value={nutrition.vitamin_b1} onChange={(e) => handleNutritionChange("vitamin_b1", e.target.value)} disabled={loading} />
                  </div>
                  <div>
                    <Label htmlFor="vitamin_b2">Vit B2 (mg)</Label>
                    <Input id="vitamin_b2" type="number" step="0.1" value={nutrition.vitamin_b2} onChange={(e) => handleNutritionChange("vitamin_b2", e.target.value)} disabled={loading} />
                  </div>
                  <div>
                    <Label htmlFor="vitamin_b3">Vit B3 (mg)</Label>
                    <Input id="vitamin_b3" type="number" step="0.1" value={nutrition.vitamin_b3} onChange={(e) => handleNutritionChange("vitamin_b3", e.target.value)} disabled={loading} />
                  </div>
                  <div>
                    <Label htmlFor="vitamin_b5">Vit B5 (mg)</Label>
                    <Input id="vitamin_b5" type="number" step="0.1" value={nutrition.vitamin_b5} onChange={(e) => handleNutritionChange("vitamin_b5", e.target.value)} disabled={loading} />
                  </div>
                  <div>
                    <Label htmlFor="vitamin_b6">Vit B6 (mg)</Label>
                    <Input id="vitamin_b6" type="number" step="0.1" value={nutrition.vitamin_b6} onChange={(e) => handleNutritionChange("vitamin_b6", e.target.value)} disabled={loading} />
                  </div>
                  <div>
                    <Label htmlFor="vitamin_b7">Vit B7 (µg)</Label>
                    <Input id="vitamin_b7" type="number" step="0.1" value={nutrition.vitamin_b7} onChange={(e) => handleNutritionChange("vitamin_b7", e.target.value)} disabled={loading} />
                  </div>
                  <div>
                    <Label htmlFor="vitamin_b9">Vit B9 (µg)</Label>
                    <Input id="vitamin_b9" type="number" step="0.1" value={nutrition.vitamin_b9} onChange={(e) => handleNutritionChange("vitamin_b9", e.target.value)} disabled={loading} />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <Input id="vitamin_e" type="number" step="0.1" value={nutrition.vitamin_e} onChange={(e) => handleNutritionChange("vitamin_e", e.target.value)} disabled={loading} />
                  </div>
                  <div>
                    <Label htmlFor="vitamin_k">Vit K (µg)</Label>
                    <Input id="vitamin_k" type="number" step="0.1" value={nutrition.vitamin_k} onChange={(e) => handleNutritionChange("vitamin_k", e.target.value)} disabled={loading} />
                  </div>
                </div>
              </section>
            </div>
