...
export default function AdminDashboard() {
  ...
  const topStatCards = [
    ...
    { title: "Non Patients", value: stats?.nonPatients ?? 0, icon: ShieldCheck, color: "bg-sky-600", textColor: "text-sky-600", bgColor: "bg-sky-50 dark:bg-sky-900/20", link: "/admin/usermanagement" },
              ...
              return (
                <section key={category} className="space-y-8 animate-in slide-in-from-bottom-4 duration-700">
                  <div className="flex items-center gap-4">
                    <div className={`h-8 w-1.5 rounded-full ${category === 'Care' ? 'bg-blue-600' :
                        ...
                        >
                          <div className="relative h-full overflow-hidden rounded-[44px] border border-gray-200 dark:border-white/[0.05] bg-white dark:bg-white/[0.02] p-8 shadow-sm group-hover:shadow-2xl group-hover:border-blue-500/40 transition-all backdrop-blur-md">
                            ...
                            <div className="flex justify-between items-start mb-8 relative z-10">
                              <div className={`p-4 rounded-[24px] shadow-sm transition-all duration-700 group-hover:scale-110 group-hover:rotate-6 ${item.color === 'blue' ? 'bg-blue-50 text-blue-600 dark:bg-blue-900/20 dark:text-blue-400' :
