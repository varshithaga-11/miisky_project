    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 font-sans">
      <div className="bg-white rounded-xl p-8 w-full max-w-md shadow-2xl relative border border-gray-100">
        <div className="mb-6 border-b pb-4">
          ...
          <p className="text-gray-500 text-xs mt-1 font-bold uppercase tracking-wider">Modify parameters for this diagnostic classification.</p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex gap-4 pt-6 border-t">
            <button
              type="submit"
              disabled={loading}
              className="flex-1 bg-blue-600 text-white font-bold py-3.5 rounded-xl disabled:opacity-50 hover:bg-blue-700 active:scale-[0.98] transition-all shadow-xl"
            >
