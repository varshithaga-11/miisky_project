    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl p-8 w-full max-w-md shadow-2xl relative border border-gray-100">
        <div className="mb-6 border-b pb-4">
          <h2 className="text-2xl font-extrabold text-gray-800 tracking-tight">New Knowledge Domain</h2>
          <p className="text-gray-500 text-sm mt-1">Group frequently asked questions into specialized support containers.</p>
        </div>

        <form onSubmit={handleSubmit}>
          <div className="mb-5">
            <label className="block text-xs font-black text-gray-500 mb-2 uppercase tracking-widest">Domain Name</label>
            <input
              type="text"
              required
          ...
          <div className="mb-5">
            <label className="block text-xs font-black text-gray-500 mb-2 uppercase tracking-widest">Context / Description</label>
            <textarea
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            <div>
              <label className="block text-xs font-black text-gray-500 mb-2 uppercase tracking-widest">Ordering</label>
              <input
                type="number"
          ...
          <div className="flex gap-4 mt-8 pt-6 border-t font-sans">
            <button
              type="submit"
              disabled={loading}
              className="flex-1 bg-blue-600 text-white font-bold py-3.5 rounded-xl disabled:opacity-50 hover:bg-blue-700 active:scale-[0.98] transition-all shadow-lg shadow-blue-100"
            >
