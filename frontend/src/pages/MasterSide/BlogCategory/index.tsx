          ...
          <Table>
            <TableHeader className="border-b border-gray-100 dark:border-white/[0.05]">
              <TableRow>
                ...
                <TableCell isHeader className="px-5 py-3 font-medium text-gray-500 text-start text-theme-xs dark:text-gray-400">Classification</TableCell>
                  ...
                  <TableRow key={cat.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/20 transition-colors">
                    ...
                    <TableCell className="px-5 py-4 text-start">
                        <div className="flex items-center gap-3">
                            <div className="w-10 h-10 bg-blue-100 text-blue-600 rounded-lg flex items-center justify-center font-bold text-xl uppercase dark:bg-blue-900/30">
                                {cat.name.charAt(0)}
                            </div>
                            <div>
                                <div className="font-bold text-gray-900 text-theme-sm dark:text-white">{cat.name}</div>
                                {cat.description && <div className="text-xs text-gray-500 line-clamp-1">{cat.description}</div>}
                            </div>
                        </div>
                    </TableCell>
                    <TableCell className="px-5 py-4 text-start font-mono font-bold text-gray-400 italic text-theme-sm">
                        #{cat.position}
                    </TableCell>
                    <TableCell className="px-5 py-4 text-start">
