...
import { updateBlogCategory, getBlogCategoryById } from "./blogcategoryapi";
...
const EditBlogCategory: React.FC<Props> = ({ id, onSuccess, onClose }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await updateBlogCategory(id, data as any);
  ...
  return (
    <div className="fixed inset-0 bg-white/50 backdrop-blur-sm flex items-center justify-center z-50 p-4 font-sans">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 w-full max-w-md relative max-h-[90vh] overflow-y-auto">
        ...
        <h2 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">Edit Blog Category</h2>
        
        {fetching ? (
          <div className="py-20 text-center text-gray-400">Loading blog category data...</div>
        ) : (
