      ...
      <header className="mb-12 flex flex-col lg:flex-row lg:items-center justify-between gap-8">
        <div className="space-y-4">
          <div className="flex items-center gap-4">
             <div className="p-4 bg-emerald-600 rounded-3xl shadow-xl shadow-emerald-500/20 rotate-3 transition-transform hover:rotate-0">
        ...
        <div className="flex items-center gap-6 bg-white dark:bg-white/[0.03] p-3 rounded-[32px] border border-slate-200/60 dark:border-white/5 shadow-sm backdrop-blur-xl">
           ...
           <button 
             onClick={fetchStats}
             disabled={loading}
             className="p-4 rounded-full bg-slate-100 dark:bg-white/5 text-slate-500 hover:bg-emerald-50 hover:text-emerald-600 transition-all"
           >
