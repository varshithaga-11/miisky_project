...
import FoodDetailModal from "../../AdminSide/Food/FoodDetailModal";
...
import { getCuisineTypeList, CuisineType } from "../../AdminSide/Food/foodapi";
...
const ListOfFoods: React.FC = () => {
  ...
  return (
    <>
      <PageMeta title="Food Database" description="View system available foods" />
      <PageBreadcrumb pageTitle="Reference Library / Food Database" />
          ...
          <Table>
            <TableHeader className="border-b border-gray-100 dark:border-white/[0.05]">
              <TableRow>
                ...
                <TableCell isHeader className="px-5 py-3 font-medium text-gray-500 text-start text-xs dark:text-gray-400">View</TableCell>
              </TableRow>
            </TableHeader>
