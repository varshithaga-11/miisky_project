                                ...
                                <div className="p-8 space-y-6">
                                    <div>
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            ...
                                            {kitchen.religion && (
                                                <span className="px-3 py-1 bg-amber-50 dark:bg-amber-900/20 text-amber-600 dark:text-amber-400 text-[10px] font-bold rounded-lg uppercase tracking-wide border border-amber-100/50 dark:border-amber-900/10">
                                                    {kitchen.religion}
                                                </span>
                                            )}
                                            {kitchen.caste && (
                                                <span className="px-3 py-1 bg-purple-50 dark:bg-purple-900/20 text-purple-600 dark:text-purple-400 text-[10px] font-bold rounded-lg uppercase tracking-wide border border-purple-100/50 dark:border-purple-900/10">
                                                    {kitchen.caste}
                                                </span>
                                            )}
                                            {kitchen.languages && (
                                                <span className="px-3 py-1 bg-teal-50 dark:bg-teal-900/20 text-teal-600 dark:text-teal-400 text-[10px] font-bold rounded-lg uppercase tracking-wide border border-teal-100/50 dark:border-teal-900/10">
                                                    {kitchen.languages}
                                                </span>
                                            )}
                                        </div>
