                                        ...
                                        <div className="p-10 flex flex-col lg:flex-row justify-between gap-10">
                                            <div className="flex-1 space-y-8">
                                                ...
                                                <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                                                    <div className="bg-gray-50/50 dark:bg-white/[0.02] p-5 rounded-3xl border border-gray-100 dark:border-white/5">
                                                    ...
                                                    <div className="col-span-2 bg-gray-50/50 dark:bg-white/[0.02] p-5 rounded-3xl border border-gray-100 dark:border-white/5">
                                            ...
                                            <div className="lg:w-80 bg-gray-50 shadow-inner flex flex-col justify-center items-center dark:bg-gray-900/50 p-10 rounded-[40px] border border-gray-100 dark:border-white/5 relative group/side overflow-hidden">
